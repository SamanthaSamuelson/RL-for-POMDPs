#based on : https://github.com/AdamStelmaszczyk/rl-tutorial

# Deep Q network: simplest RL algorithm, simply gathers data on { state, action, reward } tubples and then
# uses a neural net as a function approximator.  Uses a decaying exploration parameter.
...
print('loaded model')
env._max_episode_steps = 500
agent.evaluate_current_policy(view=1)
